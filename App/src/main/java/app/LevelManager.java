...
public class LevelManager {
    ...
    public void LoadActualLevel(){
        ...
        //app.Application.getInstance().getManager().getLogic().getBlocks().clear();
    ...
    public void Level_1(){
        //app.Application.getInstance().getManager().getLogic().getParalaxScroll().Level_1();
    ...
    public void Level_2(){
        //app.Application.getInstance().getManager().getLogic().getParalaxScroll().Level_2();
        Application.getInstance().getManager().getLogic().getParalaxScroll().LoadRandom();

        //app.Application.getInstance().getManager().getLogic().GenerateSideBlocks(400,100,0,new Vector2f(100,20),new Vector2f(300,500),2);
