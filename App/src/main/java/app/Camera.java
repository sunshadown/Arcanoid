...
public class Camera {
    ...
    Camera(){
        ...
        try ( MemoryStack stack = stackPush() ) {
            ...
            //glfwGetWindowSize(app.Application.getInstance().getWindow(), pWidth, pHeight);
            //glfwGetFramebufferSize(app.Application.getInstance().getWindow(),pWidth,pHeight);
            int []width = new int[1];
    ...
    public void Update(float dt){
        //GLFWwindow* window = app.Application::GetInstance()->GetWindow();
        ...
        //app.Application::GetInstance()->SetViewMatrix(viewMatrix);
    }
